...
LOGGING = {
    ...
    "root": {
        "handlers": ["console"],
        "level": "DEBUG",  # Change to "INFO" for less verbosity in production
    },
    "loggers": {
        "django.request": {
            "handlers": ["console"],
            "level": "ERROR",  # Log errors with tracebacks
            "propagate": False,
        },
        "django": {
            "handlers": ["console"],
...
ALLOWED_HOSTS = ["socialbook-puxe.onrender.com", "localhost", "127.0.0.1"]
